...
const paragraphs = [
  ...
  "Development of multiple microservervices using NodeJS with express framework and mongoDB",
  "Use of dockers to deploy microservices, gateway and frontend applications"
];
